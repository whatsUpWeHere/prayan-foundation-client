        ...
        <div className='facts bg-black opacity-50 flex items-center justify-evenly ' style={{ height: '400px', width: '100%' }}>
            <h1 style={{ textAlign: 'center', color: 'white' }} className="w-full ">
                <div className="container ">
                    <div className="row border mt-0">
                        <div className="col-lg-3 col-md-6 py-2">
                            <div className="facts-item">
                                <i className="flaticon-home"></i>
                                <div className="facts-text">
                                    <h3 className="facts-plus text-2xl lg:text-4xl font-semibold text-[#ffc23f]">
                        ...
                        <div className="col-lg-3 col-md-6 py-2 ">
                            <div className="facts-item">
                                ...
                                <div className="facts-text">
                                    <h3 className="facts-plus text-2xl lg:text-4xl font-semibold text-[#ffc23f]" style={{ strength: '500', font: '50px' }} >
