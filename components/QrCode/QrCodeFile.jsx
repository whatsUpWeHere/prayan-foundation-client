...
const QrCodeFile = () => {
    ...
    return (
        <section className="background-radial-gradient overflow-hidden" style={sectionStyle}>
            ...
            <div className="container px-4 py-5 px-md-5 text-center text-lg-start my-5 sticky-class card bg-glass">
                <div className="row gx-lg-5 align-items-center mb-5 sticky-class">
                    ...
                    <h2 className="mx-auto text-center text-3xl text-[#fdbe33] font-bold ">
                        Wanna Contribute</h2>
                        <p className="text-[#ed6d18] text-5xl text-center letter-wider  py-3 mx-auto font-bold">
                        Prayan Foundation</p>
                        <h5 className="text-[#131452] mx-auto ">&quot;Drops of water makes a mighty ocean&quot;- Though we are self-funded and self-sufficienctly operating since November 2022, 
                    ...
                    <div className="col-lg-6 mb-5 mb-lg-0 position-relative">
                        ...
                        <div className="card  " id="data-div">
                            <div className="card-body bg-green-100 px-4 py-5 px-md-5">
                                <form>
